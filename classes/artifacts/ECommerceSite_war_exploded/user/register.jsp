...
<head>
    <meta charset="UTF-8">
    <title>SportSphere - Register</title>
...
<body class="bg-light">
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="card p-4 shadow-sm" style="width: 100%; max-width: 400px; border-radius: 8px; border: 1px solid #ddd;">
            ...
            <p class="small text-muted mt-1" style="font-size: 12px;">By creating an account, you agree to SportSphere's Conditions of Use and Privacy Notice.</p>
