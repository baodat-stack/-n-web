...
<head>
    <meta charset="UTF-8">
    <title>SportSphere - Products</title>
    ...
    <div class="container mt-4 flex-grow-1">
        ...
        <% } else { %>
            <div class="p-4 mb-4 bg-white rounded-3 shadow-sm border text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%);">
                <h1 class="display-5 fw-bold text-dark">Welcome to SportSphere</h1>
                <p class="col-md-8 mx-auto fs-5 text-muted">Bứt phá giới hạn với trang bị thể thao đỉnh cao.</p>
            </div>
