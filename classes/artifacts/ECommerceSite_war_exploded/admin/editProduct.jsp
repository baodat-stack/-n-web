                ...
                <form action="<%= request.getContextPath() %>/updateProduct" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category" class="form-select mb-1 rounded-1" required>
                            <option value="Football" <%= "Football".equals(p.getCategory()) ? "selected" : "" %>>Football</option>
                            <option value="Running" <%= "Running".equals(p.getCategory()) ? "selected" : "" %>>Running</option>
                            <option value="Gym & Fitness" <%= "Gym & Fitness".equals(p.getCategory()) ? "selected" : "" %>>Gym & Fitness</option>
