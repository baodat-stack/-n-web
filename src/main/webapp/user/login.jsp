    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="card p-4 shadow-sm" style="width: 100%; max-width: 400px; border-radius: 8px; border: 1px solid #ddd;">
            <div class="text-center mb-4">
                <a href="<%= request.getContextPath() %>/products" class="h2 text-dark text-decoration-none fw-bold" style="color: #111 !important;">SportSphere</a>
            </div>
            ...
            <p class="small text-muted mt-2" style="font-size: 12px;">By continuing, you agree to SportSphere's Conditions of Use and Privacy Notice.</p>
            
            <div class="text-center mt-3 pt-3 border-top position-relative">
                <div class="position-absolute top-0 start-50 translate-middle bg-white px-2 small text-muted" style="margin-top: -1px;">New to SportSphere?</div>
                <a href="<%= request.getContextPath() %>/user/register.jsp" class="btn btn-light border w-100 mt-2 shadow-sm rounded-1 btn-sm py-2 bg-gradient">Create your SportSphere account</a>
            </div>
